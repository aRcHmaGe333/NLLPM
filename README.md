...
**The writer should already be leaning toward the editor before a line reaches output. The gate exists to enforce that discipline, not to rescue a free-running draft.**
---
## Original README.md
